...
print('fruits1 출력 : ', fruits1)
print('fruits2 출력 : ', fruits2)

fruits2[1] = '망고' # fruits2의 [1]번지 과일을 망고로 바꾼면...

print('fruits1 출력 : ', fruits1)   # 모두 1번지 내용이 망고로 바뀐다.
print('fruits2 출력 : ', fruits2)   # 주소를 참조하기 떄문(같은 주소)
...
# 내용 복제 2
fruits3 = fruits1[:]    # 시작부터 끝까지
print(':: 내용 복제 후 2 ::')
print('fruits1 출력 : ', fruits1)   
print('fruits2 출력 : ', fruits3)
